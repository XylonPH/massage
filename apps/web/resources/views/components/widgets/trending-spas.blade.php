<section class="rounded-2xl border border-ink-100 bg-white p-5 shadow-sm">
    ...
    <ul class="mt-5 space-y-4">
        @foreach ([
            ...
            <li>
                <a href="#" class="group flex items-start gap-3 rounded-xl p-2 transition hover:bg-ink-50">
                    <span class="flex size-6 shrink-0 items-center justify-center rounded-full bg-ink-100 text-xs font-bold text-ink-500 group-hover:bg-ember-100 group-hover:text-ember-700">{{ $index + 1 }}</span>
