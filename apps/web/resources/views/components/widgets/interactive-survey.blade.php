    ...
    <div class="relative p-5">
        ...
        <div class="relative flex items-center justify-between">
            <span class="inline-flex items-center gap-1.5 rounded-full bg-sky-100/80 px-2.5 py-1 text-xs font-bold uppercase tracking-wider text-sky-700">
                ...
                {{ __('widget.survey_label', 'Quick Survey') }}
            </span>
        ...
        <div class="relative mt-5">
            <a href="#" class="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-sky-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-600 focus:ring-offset-2">
                Start Survey
