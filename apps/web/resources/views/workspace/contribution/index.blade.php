                    ...
                    <article class="rounded-2xl border border-ink-100 bg-white p-6 shadow-sm">
                        <div class="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
                            <div>
                                ...
                                <p class="mt-3 text-xs text-ink-500">{{ __('workspace.contribution_relationship_summary', ['relationship' => __('workspace.relationship_'.$contribution->declared_establishment_relationship)]) }}</p>
                            </div>
