                ...
                <div class="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
                    <div>
                        ...
                        @else
                            ...
                            <h2 class="mt-1 text-xl font-black text-ink-950 dark:text-ink-50">{{ data_get($contribution->proposed_data, 'display_name.eng') }}</h2>
                            <p class="mt-2 text-sm text-ink-600 dark:text-ink-300">{{ data_get($contribution->proposed_data, 'address_public') }}</p>
