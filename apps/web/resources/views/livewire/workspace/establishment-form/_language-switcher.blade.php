{{-- Shared language-tab switcher for the translatable Identity/Location fields (display_name, short_description, description, direction_note, parking_note). $activeLanguageTab lives on the EstablishmentForm component, so the selection persists across tabs. --}}
