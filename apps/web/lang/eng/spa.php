...
return [
    ...
    'location_title' => 'Location, Directions & Contact',
    'public_address' => 'Public address',
    'directions_note' => 'Finding the entrance',
    'parking_information' => 'Parking information',
    'nearby_landmarks' => 'Nearby Landmarks',
    'view_on_map' => 'View on Map',
    'map_location_note' => 'The map pin opens at the public destination supplied for this profile.',
    'walk_time' => ':minutes mins walk',
    'contact_title' => 'Business contact channels',
    'contact_channel_notice' => 'These are public business channels. Availability and response time may vary.',
    'contact_url_invalid' => 'Enter a valid http, https, tel, mailto, or sms contact action.',
