...
return [
    ...
    */
    ...
    | text with something more reader friendly, such as "email address"
    | instead of "email". This helps us make the message more expressive.
    |
    */
    ...
    'attributes' => [
        ...
        'marketing_opt_in' => 'marketing email preference',
    ],
];
