...
class EstablishmentForm extends Component
{
    ...
    protected function rules(): array
    {
        $rules = [
            ...
            'state.official_name' => [$this->isContribution ? 'required' : 'nullable', 'string', 'max:255'],
            'state.country_id' => [$this->isContribution ? 'required' : 'nullable', 'integer'],
            'state.region_id' => [$this->isContribution ? 'required' : 'nullable', 'integer'],
            'state.city_name' => [$this->isContribution ? 'required' : 'nullable', 'string', 'max:255'],
            'state.street_address' => [$this->isContribution ? 'required' : 'nullable', 'string', 'max:255'],
            ...
            'state.address_public' => [$this->isContribution ? 'required' : 'nullable', 'string'],
            ...
            'state.contact_channel_list' => array_filter(['array', $this->isContribution ? 'min:1' : null, 'max:20']),
