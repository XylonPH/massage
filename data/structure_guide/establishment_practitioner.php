...
$establishment_practitioner_field_property = [
    ...
    'availability_reference_id' => ['field_label' => 'Availability Reference', 'field_description' => 'Reference to separate context-specific availability.', 'type_data' => 'S', 'type_field' => 'REF', 'is_relational' => true],
...
$establishment_practitioner_boundary = [
    ...
    'reference_field_list' => ['establishment_id', 'practitioner_id', 'eligible_establishment_service_id_list', 'availability_reference_id', 'record_verification_id_list', 'research_source_id_list'],
    'does_not_own' => ['practitioner identity, credentials, workspace access, or authoritative booking availability'],
];
