...
$establishment_contact_field_property = [
    ...
    'contact_label' => ['field_label' => 'Contact Label', 'field_description' => 'Short public purpose label, such as Reservations or Customer Support.', 'type_data' => 'S', 'type_field' => 'TXT', 'type_sql' => 'VARCHAR(100)', 'max_length' => 100],
    'contact_value_display' => ['field_label' => 'Display Contact Value', 'field_description' => 'Human-readable channel value presented to approved audiences.', 'type_data' => 'S', 'type_field' => 'TXT', 'type_sql' => 'VARCHAR(500)', 'is_mandatory' => true, 'max_length' => 500],
    'contact_value_normalized' => ['field_label' => 'Normalized Contact Value', 'field_description' => 'Canonical comparison and action value after channel-specific normalization.', 'type_data' => 'S', 'type_field' => 'TXT', 'type_sql' => 'VARCHAR(500)', 'is_indexed' => true, 'max_length' => 500],
    'contact_url' => ['field_label' => 'Contact URL', 'field_description' => 'Validated action URL appropriate to the channel, including tel, mailto, https, or an approved platform URL.', 'type_data' => 'S', 'type_field' => 'URL', 'type_sql' => 'VARCHAR(2048)', 'max_length' => 2048],
