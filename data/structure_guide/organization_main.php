...
$organization_main = [
    ...
    'alternate_name_list' => [['type_name_variant' => 'ALI', 'name' => 'Sample Wellness']], // Bounded alternate-name facts.
...
$organization_main_embedded_structure = [
    'alternate_name_list' => ['type_name_variant' => 'ALI', 'name' => 'Sample Wellness'],
...
$organization_main_field_property = [
    '_id' => ['field_label' => 'Organization ID', 'field_description' => 'Canonical 16-character organization identifier.', 'type_data' => 'S', 'is_mandatory' => true, 'is_indexed' => true],
    'organization_slug' => ['field_label' => 'Organization Slug', 'field_description' => 'Unique public route value.', 'type_data' => 'S', 'is_indexed' => true],
    'display_name' => ['field_label' => 'Display Name', 'field_description' => 'Multilingual public organization name.', 'type_data' => 'O', 'is_translatable' => true, 'is_mandatory' => true],
    'legal_name' => ['field_label' => 'Legal Name', 'field_description' => 'Registered legal name when collection and display are permitted.', 'type_data' => 'S'],
    'alternate_name_list' => ['field_label' => 'Alternate Names', 'field_description' => 'Bounded organization name variants.', 'type_data' => 'A'],
    'short_description' => ['field_label' => 'Short Description', 'field_description' => 'Multilingual public summary.', 'type_data' => 'O', 'is_translatable' => true],
    'type_organization' => ['field_label' => 'Organization Type', 'field_description' => 'Controlled organization classification.', 'type_data' => 'S', 'is_indexed' => true],
    ...
    'registration_identifier_list' => ['field_label' => 'Registration Identifiers', 'field_description' => 'Masked, typed registration identifiers.', 'type_data' => 'A'],
    'date_established' => ['field_label' => 'Date Established', 'field_description' => 'Best supported organization establishment date.', 'type_data' => 'S', 'type_field' => 'DAT'],
    'type_date_precision' => ['field_label' => 'Date Precision', 'field_description' => 'Controlled precision of date_established.', 'type_data' => 'S'],
    'type_date_qualifier' => ['field_label' => 'Date Qualifier', 'field_description' => 'Controlled qualifier of date_established.', 'type_data' => 'S'],
    'status_organization' => ['field_label' => 'Organization Status', 'field_description' => 'Real-world organization status.', 'type_data' => 'S', 'is_indexed' => true],
    'primary_establishment_id' => ['field_label' => 'Primary Establishment ID', 'field_description' => 'Optional primary public establishment.', 'type_data' => 'S'],
    'primary_media_image_id' => ['field_label' => 'Primary Media Image ID', 'field_description' => 'Optional primary image reference.', 'type_data' => 'S'],
    ...
    'status_record_lifecycle' => ['field_label' => 'Record Lifecycle Status', 'field_description' => 'Database lifecycle independent of organization status.', 'type_data' => 'S', 'is_mandatory' => true, 'is_indexed' => true],
...
$organization_main_subfield_property = [
    'alternate_name_list.type_name_variant' => ['field_label' => 'Name Variant Type', 'field_description' => 'Controlled name-variant type.', 'type_data' => 'S', 'is_mandatory' => true],
    'alternate_name_list.name' => ['field_label' => 'Alternate Name', 'field_description' => 'Organization name variant.', 'type_data' => 'S', 'is_mandatory' => true],
    'registration_identifier_list.type_registration_identifier' => ['field_label' => 'Registration Identifier Type', 'field_description' => 'Controlled registration identifier type.', 'type_data' => 'S', 'is_mandatory' => true],
    'registration_identifier_list.identifier_masked' => ['field_label' => 'Masked Identifier', 'field_description' => 'Display-safe masked identifier.', 'type_data' => 'S', 'is_mandatory' => true],
    'registration_identifier_list.country_id' => ['field_label' => 'Issuing Country ID', 'field_description' => 'Numeric issuing-country reference.', 'type_data' => 'I'],
];
...
return compact('organization_main_default', 'multilingual_text_sample', 'organization_main', 'organization_main_field_order', 'organization_main_embedded_structure', 'organization_main_field_property', 'organization_main_subfield_property', 'organization_main_index_list', 'organization_main_boundary');
