...
$user_access = [
    ...
    'scope_record_id' => null, // Target record identifier required for a non-global scope.
    'status_user_access' => 'ACT', // Current grant lifecycle state.
    'effective_at' => '2026-07-22T02:51:15Z', // UTC time when access begins.
    'expires_at' => null, // Optional UTC time when the grant stops authorizing actions.
    ...
    'revoked_at' => null, // UTC time when the grant was revoked.
    'revoked_by_user_id' => null, // Authorized user that revoked the grant.
    'revocation_reason' => null, // Required reason when the grant is revoked.
